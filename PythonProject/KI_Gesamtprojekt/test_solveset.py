...
def test_invert_real():
    ...
    assert dumeq(invert_real(sec(x), y, x), (x,
                                             ConditionSet(x, ((S(1) <= y) & (y < oo)) | ((-oo < y) & (y <= S(-1))),
                                                          Union(ImageSet(Lambda(n, 2 * n * pi + asec(y)), S.Integers), \
                                                                ImageSet(Lambda(n, 2 * n * pi - asec(y)),
                                                                         S.Integers)))))

    assert dumeq(invert_real(sec(exp(x)), y, x), (x,
                                                  ConditionSet(x, ((S(1) <= y) & (y < oo)) | ((-oo < y) & (y <= S(-1))),
                                                               Union(ImageSet(Lambda(n, log(2 * n * pi - asec(y))),
                                                                              S.Integers),
                                                                     ImageSet(Lambda(n, log(2 * n * pi + asec(y))),
                                                                              S.Integers)))))
    ...
    assert dumeq(invert_real(tanh(sin(x)), r, x), (x,
                                                   ConditionSet(x, (S(-1) <= atanh(r)) & (atanh(r) <= S(1)), Union(
                                                       ...
                                                       ImageSet(Lambda(n, 2 * n * pi - asin(atanh(r)) + pi),
                                                                S.Integers)))))
...
def test_solve_sqrt_3():
    ...
    fset = [Rational(5, 3) + 4 * sqrt(10) * cos(atan(3 * sqrt(111) / 251) / 3) / 3,
            ...
            40 * re(1 / ((Rational(-1, 2) - sqrt(3) * I / 2) * (Rational(251, 27) + sqrt(111) * I / 9) ** Rational(1,
                                                                                                                   3))) / 9 +
            sqrt(30) * sin(atan(3 * sqrt(111) / 251) / 3) / 3 + Rational(5, 3) +
            I * (-sqrt(30) * cos(atan(3 * sqrt(111) / 251) / 3) / 3 -
                 sqrt(10) * sin(atan(3 * sqrt(111) / 251) / 3) / 3 +
                 40 * im(1 / ((Rational(-1, 2) - sqrt(3) * I / 2) * (Rational(251, 27) + sqrt(111) * I / 9) ** Rational(
                        1, 3))) / 9)]
    cset = [40 * re(
        1 / ((Rational(-1, 2) + sqrt(3) * I / 2) * (Rational(251, 27) + sqrt(111) * I / 9) ** Rational(1, 3))) / 9 -
    ...
    unsolved_object = ConditionSet(q, Eq(sqrt((m - q) ** 2 + (-m / (2 * q) + S.Half) ** 2) -
                                         sqrt((-m ** 2 / 2 - sqrt(4 * m ** 4 - 4 * m ** 2 + 8 * m + 1) / 4 - Rational(1,
                                                                                                                      4)) ** 2 + (
                                                          m ** 2 / 2 - m -
                                                          sqrt(4 * m ** 4 - 4 * m ** 2 + 8 * m + 1) / 4 - Rational(1,
                                                                                                                   4)) ** 2),
                                         0), S.Reals)
...
def test_solve_trig():
    ...
    assert dumeq(solveset_real(2 * cos(x) * cos(2 * x) - 1, x),
                 Union(ImageSet(Lambda(n, 2 * n * pi + 2 * atan(sqrt(-2 * 2 ** Rational(1, 3) * (67 +
                                                                                                 9 * sqrt(
                             57)) ** Rational(2, 3) + 8 * 2 ** Rational(2, 3) + 11 * (67 +
                                                                                      9 * sqrt(57)) ** Rational(1,
                                                                                                                3)) / (
                                                                            3 * (67 + 9 * sqrt(57)) ** Rational(1,
                                                                                                                6)))),
                                S.Integers),
...
def test_solve_lambert():
    ...
    assert solveset_real(3 * log(p ** (3 * x + 5)) + p ** (3 * x + 5), x) == \
           FiniteSet(
               log((-3 ** Rational(1, 3) - 3 ** Rational(5, 6) * I) * LambertW(Rational(1, 3)) ** Rational(1, 3) / (
                           2 * p ** Rational(5, 3))) / log(p),
               log((-3 ** Rational(1, 3) + 3 ** Rational(5, 6) * I) * LambertW(Rational(1, 3)) ** Rational(1, 3) / (
                           2 * p ** Rational(5, 3))) / log(p),
...
def test_nonlinsolve_polysys():
    ...
    system = [-x ** 2 * z ** 2 + x * y * z + y ** 4, -2 * x * z ** 2 + y * z, x * z + 4 * y ** 3,
              -2 * x ** 2 * z + x * y]
...
def test_issue_14642():
    ...
    res = FiniteSet(-((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 +
                       S(43) / 2) ** 2 + (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(S(172) / 49)
                                                                                       / 2) / 2) ** 2) ** (
                                 S(1) / 6) * cos(atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                       cos(atan(S(172) / 49) / 2) / 2) / (
                                                                  3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(
                                                              S(172) / 49) / 2) / 2 + S(43) / 2)) / 3) / 3 - S(
        2) / 3 - 4 * cos(atan((27 +
                               3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(S(172) / 49) / 2) / 2) / (3 * sqrt(3) *
                                                                                                      31985 ** (
                                                                                                                  S(1) / 4) * sin(
                atan(S(172) / 49) / 2) / 2 + S(43) / 2)) / 3) / (3 * ((3 *
                                                                       sqrt(3) * 31985 ** (S(1) / 4) * sin(
                atan(S(172) / 49) / 2) / 2 + S(43) / 2) ** 2 +
                                                                      (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(
                                                                          atan(S(172) / 49) / 2) / 2) ** 2) ** (S(1) /
                                                                                                                6)) + I * (
                                -((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 +
                                   S(43) / 2) ** 2 + (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(S(172) / 49) /
                                                                                                   2) / 2) ** 2) ** (
                                             S(1) / 6) * sin(atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(
                            atan(S(172) / 49) / 2) / 2) / (3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49)
                                                                                                   / 2) / 2 + S(
                            43) / 2)) / 3) / 3 + 4 * sin(atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                               cos(atan(S(172) / 49) / 2) / 2) / (
                                                                          3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(
                                                                      atan(S(172)
                                                                           / 49) / 2) / 2 + S(43) / 2)) / 3) / (
                                            3 * ((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(
                                        S(172) / 49) / 2) / 2 + S(43) / 2) ** 2 + (
                                                             27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                             cos(atan(S(172) / 49) / 2) / 2) ** 2) ** (S(1) / 6))),
                    -S(2) / 3 - sqrt(3) * ((3 *
                                            sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 + S(
                                43) / 2) ** 2 +
                                           (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(
                                               atan(S(172) / 49) / 2) / 2) ** 2) ** (S(1)
                                                                                     / 6) * sin(
                        atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(S(172) / 49) / 2)
                              / 2) / (3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 + S(43) / 2))
                        / 3) / 6 - 4 * re(1 / ((-S(1) / 2 - sqrt(3) * I / 2) * (S(43) / 2 + 27 * I + sqrt(-256 +
                                                                                                          (
                                                                                                                      43 + 54 * I) ** 2) / 2) ** (
                                                           S(1) / 3))) / 3 + ((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(
                        atan(S(172) / 49) / 2) / 2 + S(43) / 2) ** 2 + (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                                        cos(atan(S(172) / 49) / 2) / 2) ** 2) ** (
                                S(1) / 6) * cos(atan((27 + 3 * sqrt(3) *
                                                      31985 ** (S(1) / 4) * cos(atan(S(172) / 49) / 2) / 2) / (
                                                                 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                                 sin(atan(S(172) / 49) / 2) / 2 + S(
                                                             43) / 2)) / 3) / 6 + I * (-4 * im(1 / ((-S(1) / 2 -
                                                                                                     sqrt(
                                                                                                         3) * I / 2) * (
                                                                                                                S(43) / 2 + 27 * I + sqrt(
                                                                                                            -256 + (
                                                                                                   ...
                                                                                                   (3 * sqrt(
                                                                                                    ...
                                                                                                    S(43) / 2) ** 2 + (
                                                                                                           ...
                                                                                                           atan(
                                                                                                               ...
                                                                                                               / 2) ** 2) ** (
                                                                                                   S(1) / 6) * sin(
                        atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(
                            S(172) / 49) / 2) / 2) / (
                                         3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 +
                                         S(43) / 2)) / 3) / 6 + sqrt(3) * ((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(
                        atan(S(172) /
                             49) / 2) / 2 + S(43) / 2) ** 2 + (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(
                        S(172) / 49) / 2) / 2) ** 2) ** (S(1) / 6) * cos(atan((27 + 3 * sqrt(3) * 31985 ** (S(1) /
                                                                                                            4) * cos(
                        atan(S(172) / 49) / 2) / 2) / (3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(
                        S(172) / 49) / 2) / 2 + S(43) / 2)) / 3) / 6), -S(2) / 3 - 4 * re(1 / ((-S(1) / 2 +
                                                                                                sqrt(3) * I / 2) * (
                                                                                                       ...
                                                                                                       -256 + (
                                                                                                           ...
                                                                                                           S(1)
                                                                                                           / 3))) / 3 + sqrt(
            3) * ((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 +
            ...
            atan((27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) * cos(atan(
                S(172) / 49) / 2) / 2) / (3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(S(172) / 49) / 2) / 2 +
                                          S(43) / 2)) / 3) / 6 + I * (
                                -sqrt(3) * ((3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(atan(
                            ...
                            atan(S(172) / 49) / 2) / 2 + S(43) / 2)) / 3) / 6 + ((3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                                                  sin(atan(S(172) / 49) / 2) / 2 + S(
                                    43) / 2) ** 2 + (27 + 3 * sqrt(3) * 31985 ** (S(1) / 4) *
                                                     cos(atan(S(172) / 49) / 2) / 2) ** 2) ** (S(1) / 6) * sin(
                            atan((27 + 3 * sqrt(3) * 31985 ** (
                                    S(1) / 4) * cos(atan(S(172) / 49) / 2) / 2) / (
                                             3 * sqrt(3) * 31985 ** (S(1) / 4) * sin(
                                         atan(S(172) / 49) / 2) / 2 + S(43) / 2)) / 3) / 6 - 4 * im(
                            1 / ((-S(1) / 2 + sqrt(3) * I / 2) *
...
def test_issue_13961():
    ...
    S = (ax * q - lx * q - mx, ax - gx * q - lx, bx * q ** 2 + cx * q - jx * q - nx, q * (-ax * q + lx * q + mx),
         q * (-ax + gx * q + lx))
...
def test_issue_19050():
    ...
    assert dumeq(nonlinsolve([x + y, sin(y) + cos(y)], [x, y]),
                 FiniteSet((ImageSet(Lambda(n, -2 * n * pi - 3 * pi / 4), S.Integers),
...
def test_issue_17882():
    assert solveset(-8 * x ** 2 / (9 * (x ** 2 - 1) ** (S(4) / 3)) + 4 / (3 * (x ** 2 - 1) ** (S(1) / 3)), x,
                    S.Complexes) == \
...
def test_substitution_with_infeasible_solution():
    ...
    sol = FiniteSet(
        ...
        (0, Complement(FiniteSet(p01), FiniteSet(0)), 0, p11, 0, 0, 0, 0, 0, 0, 0, -l2 * p11 / p01, -l3 * p11 / p01, l2,
         l3),
    )
