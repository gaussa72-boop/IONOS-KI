...
def test_residue():
    ...
    assert n_order(11, (
                10 ** 50 + 151) ** 2) == 10000000000000000000000000000000000000000000000030100000000000000000000000000000000000000000000022650
    ...
    assert quadratic_congruence(100000, 123456, 7415263, 48112959837082048697) == [30417843635344493501,
