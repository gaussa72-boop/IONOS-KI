...
resolvent_coeff_lambdas = {
    (4, 0): [
        ...
        lambda s1, s2, s3, s4: (
                2 * s1 ** 3 * s3 + s1 ** 2 * s2 ** 2 + s1 ** 2 * s4 - 17 * s1 * s2 * s3 + 2 * s2 ** 3 - 8 * s2 * s4 + 24 * s3 ** 2),
        lambda s1, s2, s3, s4: (
                -2 * s1 ** 5 * s4 - 2 * s1 ** 4 * s2 * s3 + 10 * s1 ** 3 * s2 * s4 + 8 * s1 ** 3 * s3 ** 2 + 10 * s1 ** 2 * s2 ** 2 * s3 -
                12 * s1 ** 2 * s3 * s4 - 2 * s1 * s2 ** 4 - 54 * s1 * s2 * s3 ** 2 + 32 * s1 * s4 ** 2 + 8 * s2 ** 3 * s3 - 32 * s2 * s3 * s4
                + 56 * s3 ** 3),
        lambda s1, s2, s3, s4: (
                2 * s1 ** 6 * s2 * s4 + s1 ** 6 * s3 ** 2 - 5 * s1 ** 5 * s3 * s4 - 11 * s1 ** 4 * s2 ** 2 * s4 - 13 * s1 ** 4 * s2 * s3 ** 2
        ...
        lambda s1, s2, s3, s4: (
                -2 * s1 ** 8 * s3 * s4 - s1 ** 7 * s4 ** 2 + 22 * s1 ** 6 * s2 * s3 * s4 + 2 * s1 ** 6 * s3 ** 3 - 2 * s1 ** 5 * s2 ** 3 * s4
        ...
        lambda s1, s2, s3, s4: (
                s1 ** 10 * s4 ** 2 - 11 * s1 ** 8 * s2 * s4 ** 2 - 2 * s1 ** 8 * s3 ** 2 * s4 + s1 ** 7 * s2 ** 2 * s3 * s4 + 15 * s1 ** 7 * s3 * s4 ** 2
    ...
    (5, 1): [
        ...
        lambda s1, s2, s3, s4, s5: (
                -8 * s1 ** 3 * s5 + 2 * s1 ** 2 * s2 * s4 + s1 ** 2 * s3 ** 2 + 30 * s1 * s2 * s5 - 14 * s1 * s3 * s4 - 6 * s2 ** 2 * s4
                + 2 * s2 * s3 ** 2 - 50 * s3 * s5 + 40 * s4 ** 2),
        lambda s1, s2, s3, s4, s5: (
                16 * s1 ** 4 * s3 * s5 - 2 * s1 ** 4 * s4 ** 2 - 2 * s1 ** 3 * s2 ** 2 * s5 - 2 * s1 ** 3 * s2 * s3 * s4 - 44 * s1 ** 3 * s4 * s5
                ...
                + 160 * s4 ** 3),
        lambda s1, s2, s3, s4, s5: (
                16 * s1 ** 6 * s5 ** 2 - 8 * s1 ** 5 * s2 * s4 * s5 - 8 * s1 ** 5 * s3 ** 2 * s5 + 2 * s1 ** 5 * s3 * s4 ** 2 + 2 * s1 ** 4 * s2 ** 2 * s3 * s5
        ...
        lambda s1, s2, s3, s4, s5: (
                -32 * s1 ** 7 * s3 * s5 ** 2 + 8 * s1 ** 7 * s4 ** 2 * s5 + 8 * s1 ** 6 * s2 ** 2 * s5 ** 2 + 8 * s1 ** 6 * s2 * s3 * s4 * s5
        ...
        lambda s1, s2, s3, s4, s5: (
                16 * s1 ** 8 * s3 ** 2 * s5 ** 2 - 8 * s1 ** 8 * s3 * s4 ** 2 * s5 + s1 ** 8 * s4 ** 4 - 8 * s1 ** 7 * s2 ** 2 * s3 * s5 ** 2
    ...
    (6, 1): [
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                -50 * s1 ** 2 * s4 * s6 + 40 * s1 ** 2 * s5 ** 2 + 30 * s1 * s2 * s3 * s6 - 14 * s1 * s2 * s4 * s5 - 6 * s1 * s3 ** 2 * s5
                + 2 * s1 * s3 * s4 ** 2 - 30 * s1 * s5 * s6 - 8 * s2 ** 3 * s6 + 2 * s2 ** 2 * s3 * s5 + s2 ** 2 * s4 ** 2 + 114 * s2 * s4 * s6
                - 50 * s2 * s5 ** 2 - 54 * s3 ** 2 * s6 + 30 * s3 * s4 * s5 - 8 * s4 ** 3 - 135 * s6 ** 2),
        lambda s1, s2, s3, s4, s5, s6: (
                125 * s1 ** 3 * s3 * s6 ** 2 - 400 * s1 ** 3 * s4 * s5 * s6 + 160 * s1 ** 3 * s5 ** 3 - 50 * s1 ** 2 * s2 ** 2 * s6 ** 2 +
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                500 * s1 ** 4 * s3 * s5 * s6 ** 2 + 625 * s1 ** 4 * s4 ** 2 * s6 ** 2 - 1400 * s1 ** 4 * s4 * s5 ** 2 * s6 + 400 * s1 ** 4 * s5 ** 4
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                -3125 * s1 ** 6 * s6 ** 4 + 2500 * s1 ** 5 * s2 * s5 * s6 ** 3 + 625 * s1 ** 5 * s3 * s4 * s6 ** 3 - 500 * s1 ** 5 * s3 * s5 ** 2 * s6 ** 2
    ...
    (6, 2): [
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                -2 * s1 ** 3 * s6 ** 2 + 2 * s1 ** 2 * s2 * s5 * s6 + 2 * s1 ** 2 * s3 * s4 * s6 - s1 ** 2 * s3 * s5 ** 2 - s1 * s2 ** 2 * s4 * s6
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                s1 ** 3 * s3 * s6 ** 2 - 3 * s1 ** 3 * s4 * s5 * s6 + s1 ** 3 * s5 ** 3 - s1 ** 2 * s2 ** 2 * s6 ** 2 + s1 ** 2 * s2 * s3 * s5 * s6
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                s1 ** 4 * s5 * s6 ** 2 + 2 * s1 ** 3 * s2 * s4 * s6 ** 2 - s1 ** 3 * s2 * s5 ** 2 * s6 - s1 ** 3 * s3 ** 2 * s6 ** 2 + 9 * s1 ** 3 * s6 ** 3
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                -s1 ** 4 * s2 * s6 ** 3 + s1 ** 4 * s3 * s5 * s6 ** 2 - 4 * s1 ** 3 * s3 * s6 ** 3 + 10 * s1 ** 3 * s4 * s5 * s6 ** 2 - 4 * s1 ** 3 * s5 ** 3 * s6
        ...
        lambda s1, s2, s3, s4, s5, s6: (
                s1 ** 6 * s6 ** 4 - 4 * s1 ** 4 * s2 * s6 ** 4 - 2 * s1 ** 4 * s3 * s5 * s6 ** 3 + s1 ** 4 * s4 ** 2 * s6 ** 3 + 8 * s1 ** 3 * s3 * s6 ** 4
