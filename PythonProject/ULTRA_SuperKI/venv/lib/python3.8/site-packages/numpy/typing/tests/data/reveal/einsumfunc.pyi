...
reveal_type(np.einsum("i,i->i", AR_LIKE_U, AR_LIKE_U, dtype=bool, casting="unsafe",
                      out=OUT_f))  # E: ndarray[Any, dtype[{float64}]
...
reveal_type(np.einsum_path("i,i,i,i->i", AR_LIKE_b, AR_LIKE_u, AR_LIKE_i,
                           AR_LIKE_c))  # E: Tuple[builtins.list[Any], builtins.str]
