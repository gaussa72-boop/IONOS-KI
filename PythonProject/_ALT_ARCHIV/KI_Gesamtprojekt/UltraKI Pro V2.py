...
<head>
    ...
    <title>UltraKI Pro V2 - Magisches Portal</title>
    <style>
        :root {
            --magic-gold: #ffd700;
            --magic-purple: #6a0dad;
        ...
        body {
            ...
            background-image:
                radial-gradient(circle at 50% 50%, rgba(106, 13, 173, 0.2) 0%, transparent 80%),
                url('https://www.transparenttextures.com/patterns/sacred-geometry.png'); /* Heilige Geometrie Textur */
            color: white;
        ...
        /* Das Allsehende Auge & Pyramide im Hintergrund */
        .background-magic {
            position: absolute;
            top: 50%;
            left: 50%;
            ...
            z-index: -1;
            opacity: 0.15;
            filter: drop-shadow(0 0 20px var(--magic-gold));
            pointer-events: none;
        }
        ...
        .message {
            ...
            border-radius: 15px;
            position: relative;
            animation: shatterIn 0.5s ease-out;
        }
        ...
        .user-message {
            align-self: flex-end;
            background: linear-gradient(135deg, var(--magic-purple), #2b0054);
            border: 1px solid var(--neon-cyan);
            box-shadow: -5px 5px 15px rgba(0, 242, 255, 0.3);
        }
        ...
        .ai-message {
            ...
            box-shadow: 5px 5px 15px rgba(255, 215, 0, 0.2);
        }
...
<body>
    ...
    <svg class="background-magic" width="400" height="400" viewBox="0 0 100 100">
        <polygon points="50,15 90,85 10,85" fill="none" stroke="#ffd700" stroke-width="0.5"/>
        <circle cx="50" cy="55" r="10" fill="none" stroke="#00f2ff" stroke-width="0.5"/>
        <circle cx="50" cy="55" r="3" fill="#ffd700"/>
    </svg>

    <header>
        <h1>UltraKI Pro V2</h1>
        <small>Eingeloggt als: {{ username }} | <a href="/logout" style="color: var(--neon-cyan)">Portal verlassen</a></small>
    </header>

    <div id="chat-container">
        <div class="message ai-message">Willkommen im magischen Zirkel. Stelle deine Frage...</div>
    </div>

    <div class="input-area">
        <input type="text" id="user-input" placeholder="Schreibe deine Nachricht an die KI...">
    ...
    <script>
        async function sendMessage() {
            ...
            container.innerHTML += `<div class="message user-message">${message}</div>`;
            input.value = '';
            ...
            // KI Nachricht anzeigen
            container.innerHTML += `<div class="message ai-message">${data.reply}</div>`;
            container.scrollTop = container.scrollHeight;
        }
    </script>
</body>
