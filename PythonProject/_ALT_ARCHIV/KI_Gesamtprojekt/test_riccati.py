...
def test_riccati_transformation():
    ...
    tests = [
        ...
        (
            ...
            (8 * x - 12) / (12 * x + 9),
            x ** 3 / (6 * x - 9),
            -x ** 4 / (6 * x - 9) - (8 * x - 12) / (Mul(2, 12 * x + 9, evaluate=False)) - (6 * x - 9) * (
                        -6 * x ** 3 / (6 * x \
    ...
    tests = [
        (
            ...
            -2 * x * (-1 / (4 * x) - (-x - 1) / (4 * x ** 2)) / (-x - 1) - (-2 * x - 1) * (-x - 1) / (
                        4 * x * (2 * x ** 2 + 2 * x \
                                 - 2)) + 1 / x
        ),
        (
            ...
            (-x - 1) / (4 * x),
            8 * x ** 2 * (1 / (4 * x) + (-x - 1) / (4 * x ** 2)) / (-x - 1) ** 2 + 4 / (-x - 1),
            -2 * x * (-1 / (4 * x) - (-x - 1) / (4 * x ** 2)) / (-x - 1) + 1 / x - Mul(3, -x - 1, evaluate=False) / (
                        8 * x ** 3)
        )]
        ...
        (
            ...
            304 * x ** 4 / (36 * x ** 5 - 216 * x ** 4 + 477 * x ** 3 - 567 * x ** 2 + 360 * x - \
                            108) - 745 * x ** 3 / (36 * x ** 5 - 216 * x ** 4 + 477 * x ** 3 - 567 * x ** 2 + \
                                                   360 * x - 108) + 631 * x ** 2 / (
                        36 * x ** 5 - 216 * x ** 4 + 477 * x ** 3 - 567 * \
                        x ** 2 + 360 * x - 108) - 292 * x / (12 * x ** 5 - 72 * x ** 4 + 159 * x ** 3 - \
                                                             189 * x ** 2 + 120 * x - 36) + S(17) / 9 - 12 / (
                        4 * x ** 6 - 24 * x ** 5 + \
...
def test_val_at_inf():
    ...
    tests = [
        ...
        (
            ...
            Poly(
                -13 * x ** 10 - x ** 9 + 5 * x ** 8 + 7 * x ** 7 + 10 * x ** 6 + 6 * x ** 5 - 7 * x ** 4 + 11 * x ** 3 - 8 * x ** 2 + 5 * x + 13,
                x),
            7
        ),
        (
...
def test_inverse_transform_poly():
    ...
    fns = [
        ...
        (30 * x ** 6 - 12 * x ** 5 + 15 * x ** 4 - 15 * x ** 2 + 10 * x + 60) / (
                    3 * x ** 10 - 45 * x ** 9 + 15 * x ** 5 + 15 * x ** 4 - 5 * x ** 3 \
                    + 15 * x ** 2 + 45 * x - 15)
    ]
    for f in fns:
...
def test_limit_at_inf():
    ...
    tests = [
        ...
        (
            Poly(
                -735 * x ** 8 - 1400 * x ** 7 + 1680 * x ** 6 - 315 * x ** 5 - 600 * x ** 4 + 840 * x ** 3 - 525 * x ** 2 \
                + 630 * x + 3780, x),
            Poly(
                1008 * x ** 7 - 2940 * x ** 6 - 84 * x ** 5 + 2940 * x ** 4 - 420 * x ** 3 + 1512 * x ** 2 + 105 * x + 168,
                x),
            -oo
        ),
        # deg(denom) == deg(numer)
        (
            ...
            Poly(
                735 * x ** 7 + 525 * x ** 6 + 720 * x ** 5 + 720 * x ** 4 - 8400 * x ** 3 - 2520 * x ** 2 + 2800 * x + 280,
                x),
            S(1) / 7
        ),
        (
    ...
    tests = [
        ...
        (
            ...
            [[269 * sqrt(6) * I / 288, -17 * sqrt(6) * I / 36, sqrt(6) * I / 3, -sqrt(6) * I * (S(16969) / 2592 \
                                                                                                - 2 * sqrt(
                        6) * I / 3) / 4], [-269 * sqrt(6) * I / 288, 17 * sqrt(6) * I / 36, -sqrt(6) * I / 3, \
        ...
        (
            ...
            [[3 * sqrt(2) * I / 4, 3 * sqrt(2) * I / 4, sqrt(2) * I / 2, sqrt(2) * I / 2, -sqrt(2) * I * (-S(7) / 8 - \
                                                                                                          3 * sqrt(
                        2) * I / 2) / 2],
             [-3 * sqrt(2) * I / 4, -3 * sqrt(2) * I / 4, -sqrt(2) * I / 2, -sqrt(2) * I / 2, \
    ...
    tests = [
        ...
        (
            ...
            {4: 1 + sqrt(2), 3: -3 - 2 * sqrt(2), 2: Mul(-1, -3 - 2 * sqrt(2), evaluate=False) / (-1 \
                                                                                                  + sqrt(2)),
             1: (-3 - 2 * sqrt(2)) / (-1 + sqrt(2)) ** 2, 0: Mul(-1, -3 - 2 * sqrt(2), evaluate=False \
                                                                 ) / (-1 + sqrt(2)) ** 3,
