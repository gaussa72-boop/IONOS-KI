...
def test_round_two():
    ...
    cases = (
        ...
        # F = 2^2
        (x ** 3 + 3 * x ** 2 - 4 * x + 4,
         DM([((1, 2), (1, 4), (1, 4)), (0, (1, 2), (1, 2)), (0, 0, 1)], QQ).transpose(), -83),
        # F = 2^2 * 3
        ...
        # F = 2^3 * 7
        (x ** 3 + 7 * x ** 2 + 7 * x - 7, DM([((1, 4), 0, (3, 4)), (0, (1, 2), (1, 2)), (0, 0, 1)], QQ).transpose(),
         49),
        # F = 2^2 * 13
        (x ** 3 + 7 * x ** 2 - x + 5, DM([((1, 2), 0, (1, 2)), (0, 1, 0), (0, 0, 1)], QQ).transpose(), -2028),
        # F = 2^4
        (x ** 3 + 7 * x ** 2 - 5 * x + 5, DM([((1, 4), 0, (3, 4)), (0, (1, 2), (1, 2)), (0, 0, 1)], QQ).transpose(),
         -140),
        # F = 5^2
        ...
        # F = 2^2 * 3^2 * 7
        (x ** 3 + 15 * x ** 2 - 9 * x + 13, DM([((1, 6), (1, 3), (1, 6)), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
         -5292),
        ...
        (QQ(5, 3) * x ** 3 + QQ(5, 3) * x ** 2 - QQ(10, 3) * x + QQ(40, 3),
         DM([[1, 0, 0], [0, 1, 0], [0, (1, 2), (1, 2)]], QQ).transpose(), -503),
    )
