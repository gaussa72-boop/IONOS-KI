...
def test_rational_parametrization():
    ...
    assert circle2.rational_parametrization(parameters=t) == (t / (t ** 2 + 1) + S(1) / 2,
                                                              t ** 2 / (t ** 2 + 1) - S(1) / 2)
    circle3 = ImplicitRegion((x, y), Eq(x ** 2 + y ** 2, 2 * x))
    assert circle3.rational_parametrization(parameters=(t,)) == (2 * t / (t ** 2 + 1) + 1,
                                                                 2 * t ** 2 / (t ** 2 + 1) - 1)
    ...
    assert sphere.rational_parametrization(parameters=(s, t)) == (2 / (s ** 2 + t ** 2 + 1),
                                                                  2 * t / (s ** 2 + t ** 2 + 1),
                                                                  2 * s / (s ** 2 + t ** 2 + 1))
