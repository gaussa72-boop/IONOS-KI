...
def test_constant_naming():
    ...
    assert rsolve(y(n + 3) + 3 * y(n + 2) + 3 * y(n + 1) + y(n), y(n)).expand() == (-1) ** n * C0 - (
        -1) ** n * C1 * n - (-1) ** n * C2 * n ** 2
...
def test_issue_15751():
    f = y(n) + 21 * y(n + 1) - 273 * y(n + 2) - 1092 * y(n + 3) + 1820 * y(n + 4) + 1092 * y(n + 5) - 273 * y(
        n + 6) - 21 * y(n + 7) + y(n + 8)
...
def test_issue_17990():
    ...
    expected = C0 * ((86 * 18 ** (S(1) / 3) / 69 + (-12 + (-1 + sqrt(3) * I) * (290412 +
                                                                                3036 * sqrt(9165)) ** (S(1) / 3)) * (
                                  1 - sqrt(3) * I) * (24201 + 253 * sqrt(9165)) **
